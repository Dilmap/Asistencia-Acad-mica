...
CREATE TABLE `asistencias` (
  ...
  KEY `asistencias_aprendiz_idaprendiz_foreign` (`aprendiz_idaprendiz`),
  KEY `asistencias_instructor_idinstructor_foreign` (`instructor_idinstructor`),
  CONSTRAINT `asistencias_aprendiz_idaprendiz_foreign` FOREIGN KEY (`aprendiz_idaprendiz`) REFERENCES `aprendizs` (`numeroDocumento`),
  CONSTRAINT `asistencias_instructor_idinstructor_foreign` FOREIGN KEY (`instructor_idinstructor`) REFERENCES `instructors` (`numeroDocumento`)
